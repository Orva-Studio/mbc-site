const Footer: React.FC = () => {
  return (
    <footer className="py-8 text-white dark:text-primary-200" style={{ backgroundColor: 'var(--color-dark-blue)' }}>
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="https://www.instagram.com/richobray" className="text-primary-400 hover:text-white transition-colors">
            ...
            <a href="https://x.com/RichOBray" className="text-primary-400 hover:text-white transition-colors">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
