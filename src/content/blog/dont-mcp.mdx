...
Tools from MCP servers use a lot of context since all their metadata is loaded into the agent harness before you write your first prompt. Also, you can't replicate results from tool calls by run them outside the agent, which is useful for debugging. 
